  ...
  <article class="registro-expo">
    ...
    <div class="row fila-espacio">
      ...
      <form class="expositores" action="alta.php" method="post">
        <div class="row">
        <fieldset>
          <legend><h5>Datos Fiscales (Elaboración de Factura y Contrato)</h5></legend>
          <div class="row">
            <div class="column small-12 medium-8">
              <label for="">Razón Social a Facturar:</label>
              <input type="text" name="rs" value="" required>
            </div>
            <div class="column small-12 medium-4">
              <label for="">RFC:</label>
              <input type="text" name="rfc" value="" required>
            </div>
            ...
            <div class="column small-12 medium-6">
              ...
              <input type="text" name="representante" value="" required>
            </div>
            <div class="column small-12 medium-3">
        ...
        <fieldset>
          <legend><h5>Información para el directorio de expositores</h5></legend>
          <div class="row">
        ...
        <fieldset>
          <legend><h5>Contactos Importantes</h5></legend>
          <div class="row">
            <div class="column small-12 medium-6">
      ...
      <fieldset>
        <div class="row">
          <legend><h5>Información del espacio</h5></legend>
        </div>
        <div class="row">

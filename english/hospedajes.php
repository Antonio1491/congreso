  ...
  <article class="">
    <div class=" header header-5">
      <div class="row align-middle">
        <div class="column text-center">
          <h3 class="titulos">LODGING</h3>
        </div>
      </div>
    </div>
    <div class="row column contenido">
      <p>Find a place to stay! Merida has a wide range of hotels and in this section we provide information of hotels within walking distance of the International Congress Center of Yucatan.</p>
    </div>
    <div class="row fila-espacio">
      <div class="column small-12 medium-4 hoteles">
          ...
          <span>Average cost per night: </span> $800 MXN
          <span>Distance: </span> 550mts, 7 minutes.
      </div>
      <div class="column small-12 medium-4 hoteles">
          <a href="http://www.hotelvictoriamerida.com/" target="_blank"><h5>Hotel Victoria</h5></a>
          <span>Average cost per night: </span> $1500 MXN
          <span>Distance: </span> 800mts, 10 minutes.
      </div>
      <div class="column small-12 medium-4 hoteles">
          <a href="http://www.wyndhammerida.com/" target="_blank"><h5>Wyndham Mérida.</h5></a>
          <span>Average cost per night: </span> $2,250 MXN
          <span>Distance: </span> 450mts, 6 minutes.
      </div>
    </div>
    <div class="row fila-espacio">
      <div class="column small-12 medium-4 hoteles">
    ...
    <div class="row fila-espacio">
      <div class="column small-12 medium-4 hoteles">
          ...
          <span>Average cost per night: </span> $1,800 MXN
          <span>Distance: </span> 350mts, 4 minutes.
      </div>
      <div class="column small-12 medium-4 hoteles">
          <a href="http://www.elconquistador.com.mx/index.html" target="_blank"><h5>El Conquistador </h5></a>
          <span>Average cost per night: </span> $1,000 MXN
          <span>Distance: </span>950mts, 12 minutes.
      </div>
      <div class="column small-12 medium-4 hoteles">
          <a href="http://hotellasamericas.wixsite.com/merida" target="_blank"><h5>Hotel Las Américas Mérida</h5></a>
          <span>Average cost per night: </span> $600 MXN
          <span>Distance: </span> 1km, 12 minutes.
      </div>
    </div>
    <div class="row fila-espacio">
      <div class="column small-12 medium-4 hoteles">

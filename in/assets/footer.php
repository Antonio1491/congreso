...
<footer>
  <div class="row align-justify text-center ">
    <div class="column small-6 medium-3 small-order-1 medium-order-1 hide-for-small-only">
      <a href="congresoParques.php"><img data-src="img/logo_congreso_bc.png" alt="1er Congreso de Parques Urbanos" class=""></a>
    </div>
    ...
    <div class="column small-6 medium-2 small-order-2 ">
      ...
      <a href="https://www.parquefundidora.org/">
        <img src="img/fundidora_bc.png" alt="Parque Fundidora" class="logo_footer">
      </a>
    </div>
  </div>
  <div class="row">
  ...
  <div class="row column expanded align-center hide-for-small-only" id="pie">
    <p><a href="http://anpr.org.mx/" target="_blank">© 2019 Asociación Nacional de Parques y Recreación</a></p>
  </div>
  ...
  function countdown(id){
    ...
    var segundos=0
      if (fecha>hoy){
          ...
          document.getElementById(id).innerHTML='<span class="faltan">MISSING </span><span class="num_dias">' + dias + ' days </span>' + horas + ':' + minutos + ':' + segundos

  ...
  <header class="header_paginas header_hospedaje">
    <?php include'assets/menu.php'; ?>
      ...
      <div class="row descripcion_header align-center">
        <h5 class="subtitulo_bc ">Find your lodging! </h5>
        <p>Monterrey has a vast range of hotels, in this section you will find information on hotels within walking distance of CINTERMEX.</p>
      </div>
  </header>
<main>

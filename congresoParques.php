      ...
      <div class="row">
        <div class="column medium-4 small-12 bloque">
          <article class="metodo_aprendizaje">
            ...
            <p>¿Te imaginas a todos los asistentes del congreso en una misma sala? ¡Este es un
               momento que nadie debe perderse! Durante las conferencias magistrales contaremos
        ...
        <div class="column medium-4 small-12 bloque">
          <article class="metodo_aprendizaje">
            ...
            <p>Los talleres son una gran oportunidad para aprender sobre el espacio público
              de una forma diferente y única. Disfruta de visitas a parques y espacios
              icónicos de la ciudad, así como clases maestras expecializadas impartidos por
      ...
      <div class="row">
        ...
        <div class="column medium-4 small-12 bloque">
          ...
          <figure>
            ...
            <h3>Expo Parques</h3>
            <p>La única exposición mexicana especializada de la industria, con más 80 empresas
              líderes en el mercado, reunidas con la única finalidad de brindarte los mejores
        ...
        <div class="column medium-4 small-12 bloque">
          <article class="metodo_aprendizaje">
            ...
            <p>¡Ha llegado el momento de intercambiar tarjetas y divertirse! Expande tu red
              profesional y disfruta  momentos realizados especialmente para ti durante los

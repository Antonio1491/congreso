...
<html class="no-js" lang="es" dir="ltr">
  <head>
    ...
    <title>Concurso | Congreso Internacional de Parques Urbanos</title>
    ...
    <div class=" header header-3">
      <div class="row align-middle">
        <div class="column text-center">
          <h1 class="titulos">CONCURSO</h1>
        </div>
      </div>
    </div>
    <div class="row contenido align-center">
      <figure>
        <img src="img/finalistas.png" alt="">
      </figure>

      <!-- <figure id="cartelConcurso">
        <img src="img/concurso.png" alt="">
      </figure> -->
      <!-- <a class="button large" href="assets/1ER CONCURSO INTERNACIONAL DE DISENO DE MOBILIARIO DE CONCRETO.pdf">Descargar Bases del Concurso</a> -->
